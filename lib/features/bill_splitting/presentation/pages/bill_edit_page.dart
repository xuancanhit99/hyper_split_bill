...
class _BillEditPageState extends State<BillEditPage> {
  ...
  void _saveBill() {
    ...
    // TODO: Get current user ID properly (e.g., from AuthBloc state)
    // This is a placeholder - DO NOT use in production without real user ID
    const placeholderUserId = 'user-placeholder-id';
    ...
    final billToSave = BillEntity(
      ...
      payerUserId: placeholderUserId, // Replace with actual user ID
